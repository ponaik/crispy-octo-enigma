...
class UserApiServiceImplTest {
    ...
    void setUp() {
        ...
        service = new UserApiServiceImpl(restTemplate, USERS_SEARCH_ENDPOINT, USERS_ENDPOINT, USERSERVICE_URL);
    }
    ...
    void givenExistingUserId_whenGetUserById_thenReturnsUserResponse() {
        // Given
        Long userId = 42L;
        UserResponse expected = new UserResponse(userId, "John", "Doe", LocalDate.of(1990, 1, 1), "john.doe@example.com");
    ...
    void givenExistingEmail_whenGetUserByEmail_thenReturnsUserResponse() {
        ...
        UserResponse expected = new UserResponse(7L, "Alice", "Smith", LocalDate.of(1985, 6, 15), email);
    ...
    void givenHttp500Error_whenGetUserByIdFallback_thenRethrowsException() {
        // Given
        Long userId = 200L;
        HttpClientErrorException serverError = HttpClientErrorException.create(HttpStatus.INTERNAL_SERVER_ERROR, "Server Error", null, null, null);

        // When / Then
        RuntimeException thrown = assertThrows(RuntimeException.class, () -> service.getUserByIdFallback(userId, serverError));
