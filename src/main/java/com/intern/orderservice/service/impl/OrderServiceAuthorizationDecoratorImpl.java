...
@Service
public class OrderServiceAuthorizationDecoratorImpl implements OrderServiceAuthorizationDecorator {
    ...
    @Autowired
    public OrderServiceAuthorizationDecoratorImpl(AdminOrderService adminOrderService, UserOrderService userOrderService, AuthorizationService authorizationService) {
